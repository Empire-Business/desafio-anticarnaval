...
MAS NO DIGITAL... É COMO SE NÃO EXISTISSE.
```
...
Vê pessoas com MENOS resultado que você, com MENOS experiência,
...
Tem histórias de clientes transformados.
...
E aí bate aquela culpa:

"Por que fulano que abriu a ontem já tem mais seguidores?"
"O que estou fazendo errado?"
"Será que digital não é o meu caminho?"
```
...
## 💡 SEÇÃO EPIPHANY BRIDGE (A HISTÓRIA)
...
### O Que É
```
O Retiro Anti-Carnaval é um evento intensivo de 4 dias onde você
vai DEFINIR seu posicionamento digital e CRIAR seu plano completo
de conteúdo.
...
## 🎁 SEÇÃO ENTREGÁVEIS E BÔNUS

### Headline
```
ALÉM DO CONTEÚDO, VOCÊ LEVA ISSO:
```
...
🏆 CERTIFICADO DE CONCLUSÃO:
   ...
   Todos que completarem as tarefas recebem certificado
   oficial do Retiro Anti-Carnaval.
```
...
### Headline
```
QUEM JA PASSOU POR ISSO, TRANSFORMOU:
```
...
✅ Não. Na verdade, quanto menor, melhor - vamos
   construir do jeito certo.

❓ Serve para qualquer nicho?

✅ Sim. O princípio de posicionamento é universal.
   Trabalhamos com médicos, advogados, consultores,
   empresários de diversos setores.

❓ Tenho que pagar algo?

✅ O evento é 100% gratuito. Nossa proposta é entregar
   valor sem pedir nada em troca.
...
✅ Não. Vamos te ensinar do básico.
```
...
Simples: porque precisamos organizar os grupos e
preparar os materiais para cada participante.

E também porque queremos que você entre com disposição
...
### Garantia
```
🔒 É 100% gratuito. Não tem carta de irmão para assinar.
    Não tem cartão de crédito. Só participar e aplicar.
```
...
Todos os resultados mencionados são típicos e variam
...
### Ícones e Emojis
```
✅ Checkmark verde para listas
🎁 Presente para bônus/entregáveis
⏰ Relógio para urgência
🔥 Chama para destaque
💡 Lâmpada para insights
📋 Prancheta para tarefas
🎯 Alvo para objetivos
🚀 Foguete para progresso
```

### Cores dos CTAs
```
Botão Primário: #D4AF37 (dourado) com texto preto
Botão Secundário: #FFFFFF (branco) com borda dourada
```

### Formato dos Botões
```
- Total width (100% em mobile)
- Altura mínima: 50px
- Border radius: 8px
- Font-weight: bold
- Text-transform: uppercase
- Arrow icon → ao lado do texto
```
...
### Ajustes para Mobile
```
- Headlines em 1-2 linhas máximo
- Parágrafos com 2-3 linhas
- CTAs sempre visíveis (sticky bottom scroll)
- Imagens otimizadas (max 100kb)
- Espaçamento reduzido mas legível
