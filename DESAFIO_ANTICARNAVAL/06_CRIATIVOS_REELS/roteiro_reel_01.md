...
### Cores
- Texto: Branco (#FFFFFF)
- Fundo dos textos: Caixa preta semi-transparente
- Destaque: Dourado (#D4AF37)

### Animações
- Textos aparecem com fade in
- Cortes rápidos (0.5s cada)
- Zoom lento na última cena
...
### Música Sugerida
- **Tipo:** Phonk ou Lo-fi energetic
- **Vibe:** Tensa mas motivacional
- **Referência:** "Phonk vibes" no Instagram Reels

### Efeitos Sonoros
- **Hook:** "Whoosh" ao mostrar o problema
- **Meio:** "Ding" quando mostra "O problema não é você"
- **Final:** "Click" no CTA

### Locução
- **Tom:** Sério, mas empático
- **Velocidade:** Média-rápida
- **Emoção:** Frustração → Esperança
...
- Preferencialmente luz natural
- Fundo clean e profissional

### Figurino
- Roupa social ou casual elegante
- Cores sóbrias (preto, cinza, branco, azul marinho)
- Evitar estampas chamativas

### Iluminação
- Luz principal (key light) vindo de 45°
- Luz de preenchimento (fill light) suave
- Evitar sombras duras no rosto

### Performance
- Olhar diretamente para câmera
- Expressões faciais marcadas
- Energia alta mas autêntica
- Gestos comedidos
...
**KPI:**
- 3% de clique no link da bio
- 50 visualizações = 1.5 cliques esperados

**Otimização:**
- Teste hooks diferentes
- Teste músicas diferentes
- Teste CTA ("comente 'SIM'" vs "link na bio")

---

*Este roteiro foi criado para gerar identificação e curiosidade.
Teste e ajuste conforme resposta do público.*
