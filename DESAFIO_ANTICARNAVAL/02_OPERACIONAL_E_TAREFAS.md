...
**Horário de Atendimento:** 09h às 20h
...
|--------|-----------------|------------------|
| [Closer 1] | Manhã e Tarde | 20 |
| [Closer 2] | Tarde e Noite | 20 |
| [Closer 3] | Manhã | 15 |
...
- [ ] Webhook de integração WhatsApp ativo
- [ ] E-mail de confirmação configurado
- [ ] Grupo de WhatsApp criado (FECHADO)
- [ ] Links das lives gerados e testados
- [ ] Materiais de cada aula prontos (PDFs)
- [ ] Certificados prontos (personalizáveis)
- [ ] Scripts de WhatsApp carregados no sistema
...
- [ ] Testar áudio/vídeo
- [ ] Ter link de backup pronto
- [ ] Moderador disponível
...
- [ ] Enviar material da tarefa
- [ ] Abrir grupo (momentos estratégicos)
- [ ] Closers iniciam abordagens
...
### Script de Boas-Vindas (WhatsApp - Automático)

```
👋 Bem-vindo ao Retiro Anti-Carnaval!

Olá, [NOME]! Seja bem-vindo(a) ao Retiro Anti-Carnaval
do Acelerador de Audiência! 🚀

Você está no lugar certo. Nesses 4 dias, vamos:
...
### Script de Lembrete de Aula (1h antes)
...
A aula de hoje começa às [HORÁRIO].
...
### Script de Entrega de Tarefa (após aula)

```
📋 TAREFA DO DIA DISPONÍVEL!

Parabéns por concluir a aula de hoje, [NOME]!

Agora é hora de colocar em prática.

📄 DOWNLOAD DA TAREFA: [LINK]

⏰ PRAZO: Até o retorno de hoje/tarde

💡 DICA: Dedique 30-45 minutos para fazer.
É na prática que o aprendizado acontece!

Quando terminar, responda este mensagem com
"FEITO" que te passamos o próximo passo.

🔥 Continua firme!
```

### Script de Abertura de Grupo (hot seat)

```
🔓 GRUPO ABERTO PARA INTERAÇÃO!

Pessoal, agora vamos abrir o grupo para
...
```
Conteúdo → Página Vendas → Formulário → Obrigado
    ↓                                  ↓
Não inscrito                    WhatsApp + E-mail
                                      ↓
                                Grupo (fechado)
                                      ↓
                              Notificações evento
...
```
Usuúdo chega → Triagem → Solução → Feedback
                      ↓
                 Não resolvido
                      ↓
                  Escalação
...
| Canal | Uso | Urgência |
|-------|-----|----------|
| WhatsApp Equipe | Comunicação rápida | Alta |
| Slack/Discord | Operação dia a dia | Média |
| E-mail | Formal, documentos | Baixa |
| Trello/Asana | Tarefas, projetos | Média |

### Árvore de Decisão de Escalamento

```
Problema ocorre
    ↓
Dá pra resolver em 15 min?
    SIM → Resolver e documentar
    NÃO ↓
Afeta +10 pessoas?
    SIM → Escalar para Gerente IMEDIATAMENTE
    NÃO ↓
Afeta o evento principal?
    SIM → Escalar para Direção IMEDIATAMENTE
    NÃO ↓
Colocar na fila e resolver em 24h
```
...
| Ação | Pontos |
|------|--------|
| Assistir aula ao vivo | 10 |
| Entregar tarefa | 20 |
| Participar do hot seat | 15 |
| Comentar no grupo | 5 |
| Indicar amigo | 30 |
...
**Top 3 da semana:**
- 1º lugar: Mentoria individual 30min
- 2º lugar: Consultoria de conteúdo em grupo
- 3º lugar: Prompt exclusivo IA

### Prêmios de Participação

**Todos que entregarem todas as tarefas:**
- Certificado de Conclusão
- Bônus exclusivo (prompt IA)
- Sorteio consultoria
...
|----------|---------------|-------------|
| Palestrante falta | Usar gravação | Gerente |
| Internet cai | Avisar, remarcar | Gerente |
| Link quebra | Enviar novo | Suporte |
| Grupo invadido | Remover, reforçar | Moderador |
| Many spamming | Remover, banir | Moderador |

### Contatos de Emergência

```
Direção: [Telefone Sandro] / [Telefone Davi]
Gerente: [Telefone]
TI: [Telefone]
```
...
- Taxa de conversão
- Receita gerada
- Learnings e melhorias

---

*Este documento deve ser atualizado conforme as decisões da equipe.*
